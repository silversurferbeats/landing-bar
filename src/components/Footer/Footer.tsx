...
export function Footer() {
    return (
        <div className="max-w-5xl p-6 mx-auto mt-10 md:-mt-40" id="footer">
            <div className="justify-between md:flex">
                <div>
                    <Image src="/assets/logoWebConnectTrans.png" width={50} height={40} alt="Logo Bank" />
                    <Reveal>
                        <p className="mt-5 text-primaryDark max-w-[250px]">Una manera de conectar.</p>
                    </Reveal>
                </div>
            ...
            <div className="items-center justify-between md:flex">
                <div className="my-3">
                    <Reveal>
                        2024 Web Connect. All Rights Reserved.
                    </Reveal>
                </div>
